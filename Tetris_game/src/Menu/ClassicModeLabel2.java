...
public class ClassicModeLabel2  extends JPanel implements KeyListener {
    ...
    public ClassicModeLabel2() {
        ...
        keyMessage.setBounds(Main.SCREEN_WIDTH[1] / 2 - 300, Main.SCREEN_HEIGHT[1] / 2 - 100, 600, 100);
        add(keyMessage);
