...
public class NormalScoreBoard2 extends JPanel implements KeyListener {
    public final JLabel mainLabel;
    private final String[] labels = new String[]{"1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th", "9th", "10th"};
    private JLabel keyMessage;
    private Timer messageTimer;
    JSONArray sortedScoreArray;
    JSONParser scoreParser;

    public NormalScoreBoard2() {
        ...
        int i;
        for(i = 0; i < Math.min(sortedScoreArray.size(), 5); ++i) {
            if (this.sortedScoreArray.get(i) != null)
            {
            ...
            {
                this.addMenuItem(String.format("%s : %.5s, Mode : %s, Score : %s", this.labels[i], null , null , null), Start_x, Start_y);
            }
        ...
        for(i = 5; i < Math.min(sortedScoreArray.size(), 10); ++i) {
