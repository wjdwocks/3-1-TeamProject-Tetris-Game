...
public class KeyControl2 extends JPanel implements KeyListener {
    ...
    public KeyControl2() {
        ...
        keyMessage.setFont(new Font("Arial", Font.BOLD, Main.SCREEN_WIDTH[1] / 30)); // 폰트 설정
    ...
    private void addMenuItem(String text, int y) {
        ...
        menuItem.setBounds((Main.SCREEN_HEIGHT[1] / 24) + Main.SCREEN_HEIGHT[1] / 72, y, 400, Main.SCREEN_HEIGHT[1] / 24); // 위치와 크기 설정
