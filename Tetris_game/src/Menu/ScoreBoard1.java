...
public class ScoreBoard1 extends JPanel implements KeyListener {
    ...
    public ScoreBoard1() {
        ...
        this.mainLabel.setSize(Main.SCREEN_WIDTH[0], Main.SCREEN_HEIGHT[0]);
        ...
        int Start_x = 0;
        int Start_y = Main.SCREEN_HEIGHT[0] / 3;
        ...
        Start_x = Main.SCREEN_WIDTH[0] / 2;
        Start_y = Main.SCREEN_HEIGHT[0] / 3;
        ...
        this.keyMessage.setBounds(Main.SCREEN_WIDTH[0] / 4, Main.SCREEN_HEIGHT[0] / 7, 800, Main.SCREEN_WIDTH[0] / 13);
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (keyCode == ((Number)Main.SettingObject.get("K_ENTER")).intValue()) {
            this.switchToScreen(Main.optionMenu1);
        } else {
    ...
    public void addMenuItem(String text, int x, int y) {
        ...
        menuItem.setFont(new Font("Arial", 1, Main.SCREEN_HEIGHT[0] / 24));
        menuItem.setForeground(Color.BLACK);
        menuItem.setBounds(x, y, Main.SCREEN_WIDTH[0] / 2, Main.SCREEN_HEIGHT[0] / 12);
